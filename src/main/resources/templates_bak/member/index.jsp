                                            ...
                                            <c:choose>
                                                ...
                                                <span class="col-20  date"><fmt:formatDate value="${gymClass['date']}"
                                                        ...
                                                        <span class="col-20  state <c:if test="${gymClass['kq'] == '尚未开课'}"> text-danger</c:if>">
                                                                ${gymClass['kq']}</span>
                                                            <a onclick="toTopic(${gymClass['course']})"><span
...
<script>
            ...
            success: function (data) {
                ...
                if (data != null && data.length > 0) {
                    $.each(data, function (index, content) {
                        ...
                        divGymClass += "<a onclick='toTopic(\""+content.course+"\")'><span class='col-20 details'>课程亮点</span></a>";
                        divGymClass += "</li>";
                    });
                } else {
    ...
    function toTopic(course) {
        if(course=="") {
            $.alert("敬请期待..." + course);
            return;
        }else{
          location.href="/index/topic";
