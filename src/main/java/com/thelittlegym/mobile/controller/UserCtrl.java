        ...
        try {
           ...
           //获孩子所有信息
            ...
            if (children != null) {
                ...
                String sqlClass = "select bj.crmzdy_80620202_id idgym,idChild,rq.crmzdy_80695562 weekNum,rq.crm_name date,bj.crmzdy_80612384 time,bj.crmzdy_80612382 course,case when kq='未考勤' then '尚未开课' else kq  end kq from(select bmks.crmzdy_81618215_id idChild,crmzdy_81486481 kq,crmzdy_81486480_id idrq from " +
